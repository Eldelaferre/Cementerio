 ...
 * @author stild
 */
@WebServlet(name = "Servlet_Actualizar_Usuario", urlPatterns = {"/Servlet_Actualizar_Usuario"})
public class Servlet_Actualizar_Usuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        y = usudao.Actualizar_Usuario(usuario);
        if (y) {
